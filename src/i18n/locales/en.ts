...
export const en = {
  ...
  importComplete:
    'Import complete: {applied} applied, {skipped} skipped, {conflicted} conflicted, {rejected} rejected.',
  ...
  onboardingFirstAccountDescription:
    'You need at least one wallet to start tracking income and expenses.',
  ...
  onboardingOpeningBalanceDescription:
    'Enter an opening balance for more accurate tracking. You can skip and update it later.',
  ...
  onboardingConfirmCategoriesDescription:
    'Turn on the categories you want to use. You can edit them later in Settings.',
  ...
  onboardingExitConfirmMessage:
    'Your current entries have not been saved. You can start again when you return.',
  ...
  dashboardPlaceholderDescription:
    'The dashboard is coming soon. You can sync your data right now.',
  ...
  transactionsDeleteConfirmMessage:
    'Are you sure you want to delete "{name}"? You can undo right after deleting.',
  ...
  transactionDetailClose: 'Close',
  transactionDetailTypeLabel: 'Transaction type',
  transactionDetailCategoryLabel: 'Category',
  transactionDetailAccountLabel: 'Account',
  transactionDetailDestinationLabel: 'Destination account',
  transactionDetailDateLabel: 'Date',
  transactionDetailNoteLabel: 'Note',
  transactionDetailDeleteAction: 'Delete transaction',
  transactionsViewDetailLabel: 'Details of {name}',
  ...
  transactionFormCategoryPlaceholder: 'Select category',
  ...
  settingsCategories: 'Manage categories',
  ...
  accountsHideConfirmMessage:
    'Are you sure you want to hide "{name}"? It will no longer appear when picking an account, but its transaction history is kept.',
  ...
  categoriesHideConfirmMessage:
    'Are you sure you want to hide "{name}"? It will no longer appear when picking a category, but past transactions keep it.',
